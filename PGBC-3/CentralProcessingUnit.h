...
private:
	...
	void rlcAdr(unsigned short &adderss);
	void rrcReg(unsigned char &reg);
	void rrcAdr(unsigned short &adderss);

	void rlReg(unsigned char &reg);
	void rlAdr(unsigned short &adderss);
	void rrReg(unsigned char &reg);
	void rrAdr(unsigned short &adderss);
	...
	void slaAdr(unsigned short &adderss);
	void sraReg(unsigned char &reg);
	void sraAdr(unsigned short &adderss);

	void swapReg(unsigned char &reg);
	void swapAdr(unsigned short &adderss);

	void srlReg(unsigned char &reg);
	void srlAdr(unsigned short &adderss);

	void resBitReg(unsigned char &reg, const unsigned char bit);
	void resBitAdr(unsigned short &adderss, const unsigned char bit);
	void setBitReg(unsigned char &reg, const unsigned char bit);
	void setBitAdr(unsigned short &adderss, const unsigned char bit);
	void testBitReg(unsigned char &reg, const unsigned char bit);
	void testBitAdr(unsigned short &adderss, const unsigned char bit);
